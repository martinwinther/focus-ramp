            ...
            <div className="space-y-8 text-white/90">
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  {APP_NAME} stores the minimum information needed to provide the service:
                </p>
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  We use your data exclusively to power the {APP_NAME} experience:
                </p>
                <ul className="mt-3 space-y-2 pl-6">
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  {APP_NAME} uses Firebase (by Google) for authentication and data storage. Your data is stored 
              ...
              <div className="rounded-lg border border-white/20 bg-white/5 p-4">
                <p className="text-sm leading-relaxed text-white/80">
                  ...
                  honest description of how {APP_NAME} handles your data. It is not a fully lawyer-reviewed 
